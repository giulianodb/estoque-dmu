...
public class RelatorioController implements Serializable {
	...
	public String paginaRelatorioEstoqueAnalitico() {
		try {
	...
	public String paginaRelatorioCampanha() {
		try {
	...
	public String paginaRelatorioFamilia() {
		try {
	...
	public String paginaRelatorioInstituicao() {
		try {
	...
	public String paginaRelatorioAnonimo() {
		try {
