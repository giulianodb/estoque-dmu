...
public class Message {
	 ...
	 * @param ae
	 */
	public static void setMessage(org.exception.ApplicationException ae) {
	 ...
	 * 
	 * @param String key chave da mensagem. Ex: "mensagem.login"
	 * @param Object[] args prâmetros que serão substituídos na mensagem
